...
<body id="page-top">
  <div id="wrapper">
    <!-- Dołączenie paska bocznego (sidebar) -->
    @include('layouts.sidebar')
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <!-- Dołączenie paska nawigacyjnego (navbar) -->
        @include('layouts.navbar')
        <div class="container-fluid">
           <!-- Nagłówek strony z tytułem (może być dynamicznie zmieniany) -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">@yield('title')</h1>
          </div>
          <!-- Zawartość strony (może być dynamicznie zmieniana w poszczególnych widokach) -->
          @yield('contents')
        </div>
      </div>
